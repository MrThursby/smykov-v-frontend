<template>
  <div class="bg-white z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div v-click-outside="closeSubmenu"
        class="flex h-16 justify-between items-center border-b-2 border-gray-100 py-2 md:justify-start md:space-x-10">
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          <div class="relative">
            ...
            <button type="button"
                    :class="openedSubmenu && openedSubmenuId === 1 ? 'text-gray-900' : 'text-gray-500'"
              ...
              -->
              <svg
                :class="openedSubmenu && openedSubmenuId === 1 ? 'text-gray-600' : 'text-gray-400'"
            ...
            >
              <div v-show="openedSubmenu && openedSubmenuId === 1"
          ...
          <div class="relative">
            <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
            <button type="button"
                    :class="openedSubmenu && openedSubmenuId === 2 ? 'text-gray-900' : 'text-gray-500'"
                    @click="toggleSubmenu(2)"
                    class="inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
              <span>More</span>
              <!--
                Heroicon name: chevron-down
              ...
              -->
              <svg
                :class="openedSubmenu && openedSubmenuId === 2 ? 'text-gray-600' : 'text-gray-400'"
                class="text-gray-400 h-5 w-5 group-hover:text-gray-500 group-focus:text-gray-500 transition ease-in-out duration-150"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
                      d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
            ...
            <transition
              ...
              leave-to-class="opacity-0 translate-y-1"
            >
              <div v-show="openedSubmenu && openedSubmenuId === 2"
                  ...
                  <div class="rounded-lg shadow-xs overflow-hidden">
                    ...
                    <div class="px-5 py-5 bg-gray-100 space-y-5 sm:px-8 sm:py-8">
                      ...
                      <div class="text-sm leading-5">
                        <a href="#"
                           class="font-medium text-primary-600 hover:text-primary-500 transition ease-in-out duration-150">
                          View all posts &rarr;
                        </a>
                      </div>
                    </div>
        ...
        <div v-if="!$auth.loggedIn"
          ...
          <header-link href="/auth/login">
            Войти
          </header-link>
          <span class="inline-flex rounded-md shadow-sm">
            <btn href="/auth/register">Зарегистрироваться</btn>
          </span>
        </div>
        <div v-if="$auth.loggedIn" class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
          <div class="relative hidden md:block">
            <div>
              <button @click="toggleSubmenu(3)"
                      class="max-w-xs flex items-center text-sm rounded-full text-dark focus:outline-none focus:shadow-solid"
                      id="user-menu"
                      aria-label="User menu"
                      aria-haspopup="true">
                <img class="h-8 w-8 mr-2 rounded-full" :src="$auth.user.avatar" alt="">
            ...
            <transition
              ...
              leave-to-class="opacity-0 translate-y-1"
            >
              <div v-show="openedSubmenu && openedSubmenuId === 3" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                <div class="py-1 rounded-md bg-white shadow-xs" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Профиль</a>

                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Закладки</a>
                  <nuxt-link to="/profile/purchases" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Куплено</nuxt-link>

                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Настройки</a>

                  <a href="#" @click="logoutUser" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Выход</a>
                </div>
              </div>
            </transition>
    ...
    >
      <div v-show="openedMenu" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-lg overflow-y-auto max-h-screen ">
              ...
              <div>
                <nav class="grid gap-y-8">
                  <a href="#"
                    ...
                    <!-- Heroicon name: chart-bar -->
                    <svg class="flex-shrink-0 h-6 w-6 text-primary-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                         viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
            ...
            <span class="w-full flex rounded-md shadow-sm">
              <a href="#"
                ...
                <p class="text-center text-base leading-6 font-medium text-gray-500">
                  Есть аккаунт?
                  <a href="#" class="text-primary-600 hover:text-primary-500 transition ease-in-out duration-150">
                    Войти
                  </a>
                </p>
              </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      toggleSubmenu(id) {
        if (this.openedSubmenu === false) {
          this.openedSubmenu = true
          this.openedSubmenuId = id
        } else {
          if (this.openedSubmenuId === id) {
            this.closeSubmenu()
          } else {
            this.openedSubmenuId = id
          }
